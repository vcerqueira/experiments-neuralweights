...
def run_hpo_search(
    ...
    """Run HPO search with classifier early stopping callbacks.
    """
    ...
    for config_sample in config_list:
        ...
        nf = NeuralForecast(models=[nf_model_clf, nf_model_nocb], freq=freq)
        ...
        model_aliases = [f'{model_name}-CLF', f'{model_name}-NoCB']
